    ...
    private void careunitset(ArrayList<String> lists) {
        for (String list : Lists){
            if(list.equalsIgnoreCase("ICU")){
                ...
                cardView1.setCardBackgroundColor (Color.parseColor ("#FF0000"));
            }
            else if(list.equalsIgnoreCase("ICCU")){
                cardView2.setEnabled(false);
                cardView2.setCardBackgroundColor (Color.parseColor ("#FF0000"));
            }
            else if(list.equalsIgnoreCase("SICU")){
                cardView3.setEnabled(false);
                cardView3.setCardBackgroundColor (Color.parseColor ("#FF0000"));
            }
            else{
                cardView4.setEnabled(false);
                cardView4.setCardBackgroundColor (Color.parseColor ("#FF0000"));
            }
        }
    }
}
